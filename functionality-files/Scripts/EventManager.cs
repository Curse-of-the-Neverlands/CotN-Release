...
public class EventManager : MonoBehaviour {
    ...
    private EventDelegate AddDelegate<T>(EventDelegate<T> del) where T : UnityEvent {
    ...
    public void AddListener<T> (EventDelegate<T> del) where T : UnityEvent {
        AddDelegate<T>(del);
    }

    public void AddListenerOnce<T> (EventDelegate<T> del) where T : UnityEvent {
    ...
    public void RemoveListener<T> (EventDelegate<T> del) where T : UnityEvent {
    ...
    public bool HasListener<T> (EventDelegate<T> del) where T : UnityEvent {
    ...
    public bool QueueEvent(UnityEvent evt) {
    ...
    void Update() {
        ...
        while (m_eventQueue.Count > 0) {
            ...
            UnityEvent evt = m_eventQueue.Dequeue() as UnityEvent;
            TriggerEvent(evt);
