...
public class Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.A)) {
            ...
            PlayerPosX -= PlayerSpeed * Time.deltaTime;
        ...
        if(Input.GetKey(KeyCode.W)) {
            ...
            PlayerPosZ += PlayerSpeed * Time.deltaTime;
        }
        ...
        this.transform.position = new Vector3(PlayerPosX, this.transform.position.y, PlayerPosZ);
    }
}
